...
size: ~34 MB
SHA256: 34343d577ebadebe957322460313723945f6b96195ac2053a27968fdb4045870
```

Проверка:

```bash
sha256sum ~/forge-cmp-610.43.03-k6.8.0-139-known-good.tar.gz
```

Ожидаемый SHA256:

```text
34343d577ebadebe957322460313723945f6b96195ac2053a27968fdb4045870
```
