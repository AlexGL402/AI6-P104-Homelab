...
Основное назначение AI6 Host Monitor — мониторинг и управление **AI/LLM-нагрузкой**. Модуль ForgeMiner/Pearl оставлен только как опциональный инструмент для **кратковременного тестирования видеокарт, проверки их стабильности и сравнения характеристик/производительности разных GPU** и **по умолчанию отключён**.
